...
export default function Home() {
  ...
  // State om het burger menu te tonen of te verbergen
  ...
  // Functie om de burger menu te openen/sluiten
  const toggleMenu = () => {
